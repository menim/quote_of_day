...
var elements = (function() {
	var quote = document.getElementById("quote"),
		...
		spreadUrl =
			"https://spreadsheets.google.com/feeds/list/17T8jqTsiOdfGXKhAg21cpJAfV6zSHzuMF-nXbk0ltHs/od6/public/values?alt=json",
		...
		hangingWords = function(str) {
			var arr = str.split(" "), arrLen = arr.length;
	...
	if ("") {
		fetch(elements.spreadUrl, { method: "get" })
			...
			.catch(function(error) {
				console.log(
					"There has been a error with fetch:" + error.message
				);
			});
	} else {
